...
ActiveRecord::Schema.define(version: 20150219005434) do
  ...
  add_index "jobs", ["employment_type_id"], name: "index_jobs_on_employment_type_id", using: :btree
  add_index "jobs", ["experience_id"], name: "index_jobs_on_experience_id", using: :btree
  add_index "jobs", ["jobfunction_id"], name: "index_jobs_on_jobfunction_id", using: :btree
